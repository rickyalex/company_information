		  ...
		  <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
			  <div class="x_panel tile fixed_height_400">
							...
							echo form_open_multipart('Welcome/unggahexcel', $attributes);
							?>
							<div class="form-group">
								<input type="file" id="welcome_id" name="welcome_name" />
							</div>
							<div>
							...
							<div>
									<a href="<?php echo base_url();?>welcome/adddata/">
	...
	function actionFormatter(value, row, index) {
    	...
    	var id = objek.id;
				return [
    				...
    				'</a>    ',
    				'<a class="edit btn btn-info btn-xs" href="'+base_url+'welcome/editdata/'+id+'" title="Ubah">',
	...
	window.actionEvents = {
        ...
        'click .remove': function (e, value, row, index) {
          //  alert('delete: ' + JSON.stringify(row));
			...
			//alert(id);
     	    $.ajax({
    			  url: '<?php echo base_url();?>welcome/removedata/',
    			  dataType: 'json',
    			  type: 'POST',
	...
	//form submit menggunakan FormData harus menggunakan browser versi IE 10+, Firefox 4.0+, Chrome 7+, Safari 5+, Opera 12+
			jQuery("form#welcome").submit(function (event) {
				...
				jQuery.ajax({
					...
					contentType: false,
					processData: false,
					url: "<?php echo base_url(); ?>welcome/unggahexcel/",
