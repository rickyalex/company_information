...
<script = type="text/javascript">
	...
	function actionFormatter(value, row, index) {
    	...
    	var id = objek.id;
				return [
    				...
    				'</a>    ',
    				'<a class="edit btn btn-info btn-xs" href="'+base_url+'company_safety_information/editdata/'+id+'" title="Ubah">',
     	    ...
     	    $.ajax({
    			  ...
    			  success: function (data){
    				  if(data == true){
                          ...
                          location.reload();
    					  $('#getdata').load('company_safety_information');
    				  }
    			  }
    			}); 
            console.log(value, row, index);
	...
	//form submit menggunakan FormData harus menggunakan browser versi IE 10+, Firefox 4.0+, Chrome 7+, Safari 5+, Opera 12+
			jQuery("form#company_safety_information").submit(function (event) {
				...
				jQuery.ajax({
					...
					contentType: false,
					processData: false,
					url: "<?php echo base_url(); ?>company_safety_information/unggahexcel/",
