...
{
    // default connection
    public static $dbname = 'company_information'; // Your database name
    public static $dbuser = 'root'; // Your database username
    public static $dbpass = ''; // // Your database password
    public static $dbhost = '10.20.0.31'; // Your database host, 'localhost' is default.
    ...
    public static $limit_list = array('5', '10', '15', '20', '25', '30', '35', '40', 'all'); // default limits list
